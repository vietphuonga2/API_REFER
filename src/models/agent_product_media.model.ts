...
module.exports = function (sequelize, DataTypes) {
  const AgentProductMedia = sequelize.define(
    'AgentProductMedia',
    {
      id: {
        allowNull: false,
      ...
      agent_product_id: { allowNull: true, type: DataTypes.INTEGER },
      media_url: {
        allowNull: false,
    ...
    },
    {
      ...
      tableName: 'agent_product_media',
      version: true,
      hooks: {},
    },
  );

  AgentProductMedia.associate = (db) => {
    db.AgentProductMedia.belongsTo(db.AgentProduct, {
      foreignKey: {
