...
module.exports = function (sequelize, DataTypes) {
  const DFStatusOrder = sequelize.define(
    'DFStatusOrder',
    {
      id: {
        allowNull: false,
    ...
    },
    {
      ...
      tableName: 'df_status_order',
      version: true,
      hooks: {},
    },
  );

  DFStatusOrder.associate = (db) => {
    db.DFStatusOrder.hasMany(db.Order, { foreignKey: { name: 'status_order_id' } });
  };
  return DFStatusOrder;
};
